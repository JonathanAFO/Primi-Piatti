...
function renderProductsAdmin() {
  ...
  grid.innerHTML = productsList.map(product => `
    <div class="product-admin-card ${product.paused ? 'product-paused' : ''}">
      <img src="${product.image || 'https://placehold.co/400x200/f3f4f6/9ca3af?text=Sem+Imagem'}" 
           alt="${product.name}" 
           class="product-admin-image"
           onerror="this.src='https://placehold.co/400x200/f3f4f6/9ca3af?text=Sem+Imagem'">
